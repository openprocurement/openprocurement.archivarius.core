.. openprocurement.archivarius.core documentation master file, created by
   sphinx-quickstart on Wed Oct  1 02:29:13 2014.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

.. title:: OpenProcurement Archivarius

.. meta::
    :google-site-verification: kmqHGqhpzgef4t5OVKoQCPa5v-CK14HOLmVrZV2QgmQ

Welcome to openprocurement.archivarius.core's documentation!
============================================================
...
the `issue tracker
<https://github.com/openprocurement/openprocurement.archivarius.core/issues>`_.
